...
!(function () {
  ...
  e.length &&
    ...
    document.querySelectorAll(".input-group").forEach(function (e) {
      e.addEventListener("click", function (e) {
        e.target.classList.contains("button-plus")
          ? (function (e) {
              e.preventDefault();
              var t = e.target,
          ...
          : e.target.classList.contains("button-minus") &&
            (function (e) {
              e.preventDefault();
              var t = e.target,
                n = t.getAttribute("data-field"),
  ...
  var n = document.querySelectorAll(".flatpickr");
  n.length &&
    n.forEach(function (e) {
      flatpickr(e, { disableMobile: !0 });
    });
  var o = document.querySelectorAll(".stopevent");
  o.length &&
    o.forEach(function (e) {
      e.addEventListener("off.bs.collapse.data-api", function (e) {
        e.stopPropagation();
      });
    });
  const a = document.querySelector("#checkAll");
  a &&
    a.addEventListener("click", function () {
      document.querySelectorAll('input[type="checkbox"]').forEach(function (e) {
        e !== a && (e.checked = a.checked);
      });
    });
  var r = document.getElementById("liveAlertPlaceholder");
  if (r) {
    var l = document.getElementById("liveAlertBtn");
    l &&
  ...
  var c = document.getElementById("priceRange");
  if (c) {
    noUiSlider.create(c, {
      connect: !0,
      behaviour: "tap",
    ...
    var i = document.getElementById("priceRange-value");
    c.noUiSlider.on("update", function (e) {
      i.innerHTML = e.join(" - ");
    });
  }
  var s = document.querySelectorAll(".file-input");
  s.length &&
  ...
  const u = document.getElementById("liveToastBtn"),
    d = document.getElementById("liveToast");
  u &&
    d &&
...
tagsInput && new Tagify(tagsInput);
